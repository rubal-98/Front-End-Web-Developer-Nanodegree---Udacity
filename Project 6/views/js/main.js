...
function updatePositions() {
    ...
    for (var e = document.querySelectorAll(".mover"), a = [], r = 0; r < e.length; r++) a[r] = Math.sin(document.body.scrollTop / 1250 + r % 5);
    for (var n = 0; n < e.length; n++) e[n].style.left = e[n].basicLeft + 100 * a[n] + "px";
